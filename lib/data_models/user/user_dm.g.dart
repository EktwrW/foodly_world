...
_UserDM _$UserDMFromJson(Map<String, dynamic> json) => _UserDM(
      ...
      signUpDate: json['created_at'] == null ? null : DateTime.parse(json['created_at'] as String),
      lastUpdated: json['updated_at'] == null ? null : DateTime.parse(json['updated_at'] as String),
      ...
      roleId: $enumDecodeNullable(_$UserRoleEnumMap, json['role_id']) ?? UserRole.visitor,
      ...
      business:
          (json['business'] as List<dynamic>?)?.map((e) => BusinessDM.fromJson(e as Map<String, dynamic>)).toList() ??
              const [],
      userPrefs: json['user-prefs'] == null ? null : UserPrefsDM.fromJson(json['user-prefs'] as Map<String, dynamic>),
      ...
      addresses:
          (json['addresses'] as List<dynamic>?)?.map((e) => AddressDM.fromJson(e as Map<String, dynamic>)).toList() ??
              const [],
      favoriteBusiness: (json['favorite_businesses'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
      favoriteMenus: (json['favorite_menus'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
      favoriteItems: (json['favorite_items'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
      favoriteCombos: (json['favorite_combos'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
      savedPromotions: (json['saved_promotions'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
      ...
      following: (json['following'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
...
Map<String, dynamic> _$UserDMToJson(_UserDM instance) => <String, dynamic>{
      ...
      if (instance.signUpDate?.toIso8601String() case final value?) 'created_at': value,
      if (instance.lastUpdated?.toIso8601String() case final value?) 'updated_at': value,
      if (instance.deletedAt?.toIso8601String() case final value?) 'deleted_at': value,
      if (instance.dateOfBirth?.toIso8601String() case final value?) 'date_of_birth': value,
      if (_$UserGenderEnumMap[instance.gender] case final value?) 'gender': value,
      ...
      if (instance.socialProvider?.map((e) => e.toJson()).toList() case final value?) 'social_provider': value,
      if (instance.emailVerifiedAt?.toIso8601String() case final value?) 'email_verified_at': value,
...
_AddressLabelDM _$AddressLabelDMFromJson(Map<String, dynamic> json) => _AddressLabelDM(
      id: (json['id'] as num?)?.toInt(),
      uuid: json['uuid'] as String?,
...
Map<String, dynamic> _$AddressLabelDMToJson(_AddressLabelDM instance) => <String, dynamic>{
      if (instance.id case final value?) 'id': value,
      if (instance.uuid case final value?) 'uuid': value,
      'name': instance.name,
...
_AddressDM _$AddressDMFromJson(Map<String, dynamic> json) => _AddressDM(
      ...
      country: const FoodlyCountriesConverter().fromJson(json['country'] as String?),
      zipCode: json['zip_code'] as String,
      latitude: (json['latitude'] as num).toDouble(),
      longitude: (json['longitude'] as num).toDouble(),
      addressLabel: AddressLabelDM.fromJson(json['label'] as Map<String, dynamic>),
      principal: json['principal'] as bool? ?? false,
      createdAt: DateTime.parse(json['created_at'] as String),
      updatedAt: DateTime.parse(json['updated_at'] as String),
    );

Map<String, dynamic> _$AddressDMToJson(_AddressDM instance) => <String, dynamic>{
      'id': instance.id,
      'uuid': instance.uuid,
      'address': instance.address,
      'city': instance.city,
      if (const FoodlyCountriesConverter().toJson(instance.country) case final value?) 'country': value,
...
_LoginProviderDM _$LoginProviderDMFromJson(Map<String, dynamic> json) => _LoginProviderDM(
      id: (json['id'] as num).toInt(),
      uuid: json['uuid'] as String,
      provider: json['provider'] as String,
      providerId: json['provider_id'] as String,
...
Map<String, dynamic> _$LoginProviderDMToJson(_LoginProviderDM instance) => <String, dynamic>{
      'id': instance.id,
      'uuid': instance.uuid,
