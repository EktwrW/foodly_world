...
_GeocodingResultDM _$GeocodingResultDMFromJson(Map<String, dynamic> json) => _GeocodingResultDM(
...
Map<String, dynamic> _$GeocodingResultDMToJson(_GeocodingResultDM instance) => <String, dynamic>{
