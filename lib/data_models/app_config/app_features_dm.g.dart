...
_AppFeaturesDM _$AppFeaturesDMFromJson(Map<String, dynamic> json) => _AppFeaturesDM(
      placesProxyEnabled: json['places_proxy_enabled'] as bool? ?? true,
      groupOrdersEnabled: json['group_orders_enabled'] as bool? ?? false,
    );

Map<String, dynamic> _$AppFeaturesDMToJson(_AppFeaturesDM instance) => <String, dynamic>{
