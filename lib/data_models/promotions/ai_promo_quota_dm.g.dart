...
_AiPromoQuotaResponse _$AiPromoQuotaResponseFromJson(Map<String, dynamic> json) => _AiPromoQuotaResponse(
...
Map<String, dynamic> _$AiPromoQuotaResponseToJson(_AiPromoQuotaResponse instance) => <String, dynamic>{
