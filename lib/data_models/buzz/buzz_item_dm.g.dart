...
_BuzzResponseDM _$BuzzResponseDMFromJson(Map<String, dynamic> json) => _BuzzResponseDM(
      data: (json['data'] as List<dynamic>?)?.map((e) => BuzzItemDM.fromJson(e as Map<String, dynamic>)).toList() ??
          const [],
      meta: json['meta'] == null ? null : BuzzMetaDM.fromJson(json['meta'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$BuzzResponseDMToJson(_BuzzResponseDM instance) => <String, dynamic>{
...
Map<String, dynamic> _$BuzzMetaDMToJson(_BuzzMetaDM instance) => <String, dynamic>{
...
Map<String, dynamic> _$BuzzItemDMToJson(_BuzzItemDM instance) => <String, dynamic>{
      'uuid': instance.uuid,
