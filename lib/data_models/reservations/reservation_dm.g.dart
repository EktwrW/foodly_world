...
_ReservationsResponseDM _$ReservationsResponseDMFromJson(Map<String, dynamic> json) => _ReservationsResponseDM(
      reservations: (json['reservations'] as List<dynamic>?)
              ?.map((e) => ReservationDM.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      meta: json['meta'] == null ? null : ReservationsMetaDM.fromJson(json['meta'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReservationsResponseDMToJson(_ReservationsResponseDM instance) => <String, dynamic>{
      'reservations': instance.reservations.map((e) => e.toJson()).toList(),
      if (instance.meta?.toJson() case final value?) 'meta': value,
    };

_ReservationsMetaDM _$ReservationsMetaDMFromJson(Map<String, dynamic> json) => _ReservationsMetaDM(
...
Map<String, dynamic> _$ReservationsMetaDMToJson(_ReservationsMetaDM instance) => <String, dynamic>{
...
_ReservationCreateResponseDM _$ReservationCreateResponseDMFromJson(Map<String, dynamic> json) =>
    _ReservationCreateResponseDM(
      success: json['success'] as bool? ?? false,
      message: json['message'] as String? ?? '',
      reservation:
          json['reservation'] == null ? null : ReservationDM.fromJson(json['reservation'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReservationCreateResponseDMToJson(_ReservationCreateResponseDM instance) => <String, dynamic>{
      'success': instance.success,
      'message': instance.message,
      if (instance.reservation?.toJson() case final value?) 'reservation': value,
    };

_ReservationActionResponseDM _$ReservationActionResponseDMFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ReservationActionResponseDMToJson(_ReservationActionResponseDM instance) => <String, dynamic>{
      'success': instance.success,
      'message': instance.message,
      if (instance.reservation?.toJson() case final value?) 'reservation': value,
    };

_ReservationShowResponseDM _$ReservationShowResponseDMFromJson(Map<String, dynamic> json) => _ReservationShowResponseDM(
      reservation:
          json['reservation'] == null ? null : ReservationDM.fromJson(json['reservation'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReservationShowResponseDMToJson(_ReservationShowResponseDM instance) => <String, dynamic>{
      if (instance.reservation?.toJson() case final value?) 'reservation': value,
    };

_PendingReservationsCountDM _$PendingReservationsCountDMFromJson(Map<String, dynamic> json) =>
    _PendingReservationsCountDM(
      pendingCount: (json['pending_count'] as num?)?.toInt() ?? 0,
    );

Map<String, dynamic> _$PendingReservationsCountDMToJson(_PendingReservationsCountDM instance) => <String, dynamic>{
      'pending_count': instance.pendingCount,
    };

_ReservationDM _$ReservationDMFromJson(Map<String, dynamic> json) => _ReservationDM(
      reservationId: (json['reservation_id'] as num?)?.toInt(),
      reservationUuid: json['reservation_uuid'] as String?,
      status: $enumDecodeNullable(_$ReservationStatusEnumMap, json['status']) ?? ReservationStatus.pending,
      bookingType: $enumDecodeNullable(_$BookingTypeEnumMap, json['booking_type']) ?? BookingType.table,
      reservationDate: json['reservation_date'] == null ? null : DateTime.parse(json['reservation_date'] as String),
      ...
      rejectedAt: json['rejected_at'] == null ? null : DateTime.parse(json['rejected_at'] as String),
      ...
      quotedAt: json['quoted_at'] == null ? null : DateTime.parse(json['quoted_at'] as String),
      messagesCount: (json['messages_count'] as num?)?.toInt() ?? 0,
      createdAt: json['created_at'] == null ? null : DateTime.parse(json['created_at'] as String),
      updatedAt: json['updated_at'] == null ? null : DateTime.parse(json['updated_at'] as String),
    );

Map<String, dynamic> _$ReservationDMToJson(_ReservationDM instance) => <String, dynamic>{
      ...
      if (instance.reservationDate?.toIso8601String() case final value?) 'reservation_date': value,
      ...
      if (instance.cancelledAt?.toIso8601String() case final value?) 'cancelled_at': value,
      if (instance.confirmedAt?.toIso8601String() case final value?) 'confirmed_at': value,
      if (instance.rejectedAt?.toIso8601String() case final value?) 'rejected_at': value,
      ...
      if (instance.userPhoneCountryCode case final value?) 'user_phone_country_code': value,
      if (instance.servicePackageUuid case final value?) 'service_package_uuid': value,
      if (instance.servicePackageTitle case final value?) 'service_package_title': value,
      ...
      if (_$EventTypeEnumMap[instance.eventType] case final value?) 'event_type': value,
      ...
      if (instance.quotedAt?.toIso8601String() case final value?) 'quoted_at': value,
