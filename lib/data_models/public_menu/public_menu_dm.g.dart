...
_PublicMenuResponseDM _$PublicMenuResponseDMFromJson(Map<String, dynamic> json) => _PublicMenuResponseDM(
      business: BusinessDM.fromJson(json['business'] as Map<String, dynamic>),
      menu: MenuDM.fromJson(json['menu'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PublicMenuResponseDMToJson(_PublicMenuResponseDM instance) => <String, dynamic>{
