...
_PromotionDTO _$PromotionDTOFromJson(Map<String, dynamic> json) => _PromotionDTO(
      ...
      promoActiveDays: json['promo_active_days'] == null
          ? null
          : PromoDaysDM.fromJson(json['promo_active_days'] as Map<String, dynamic>),
      available: json['available'] as bool?,
      mediaLink: json['media_link'] as String?,
    );

Map<String, dynamic> _$PromotionDTOToJson(_PromotionDTO instance) => <String, dynamic>{
      ...
      if (instance.promoActiveDays?.toJson() case final value?) 'promo_active_days': value,
