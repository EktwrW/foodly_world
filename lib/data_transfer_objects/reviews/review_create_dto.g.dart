...
_ReviewCreateDTO _$ReviewCreateDTOFromJson(Map<String, dynamic> json) => _ReviewCreateDTO(
...
Map<String, dynamic> _$ReviewCreateDTOToJson(_ReviewCreateDTO instance) => <String, dynamic>{
      ...
      if (instance.businessVisitedAt case final value?) 'business_visited_at': value,
    };
