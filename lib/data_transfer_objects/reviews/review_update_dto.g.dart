...
_ReviewUpdateDTO _$ReviewUpdateDTOFromJson(Map<String, dynamic> json) => _ReviewUpdateDTO(
...
Map<String, dynamic> _$ReviewUpdateDTOToJson(_ReviewUpdateDTO instance) => <String, dynamic>{
