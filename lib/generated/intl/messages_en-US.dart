...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m55(guests, items) => "${guests} guests · ${items} items";

  static String m56(count, total) => "${count} orders · ${total}";

  static String m57(delivered, total) =>
      "${delivered}/${total} items delivered";

  static String m58(n) => "ROUND ${n}";

  static String m59(item) =>
      "Remove \"${item}\" from the bill? It stays visible to the guest, marked as removed by the business.";

  static String m60(size) => "max ${size}";

  static String m61(maxSize) => "Max Size: ${maxSize}";

  static String m62(count) => "${count} new messages";

  static String m63(radius) =>
      "No nearby businesses in this category within ${radius} km.";

  static String m64(text) => "Notes: ${text}";

  static String m65(count) => "Party size: ${count}";

  static String m66(count) => "You have ${count} pending reservations";

  static String m67(max) => "Maximum ${max} photos";

  static String m68(max) => "Photos (optional, up to ${max})";

  static String m69(action, errorMsg) =>
      "Something went wrong when ${action} the item photo(s): ${errorMsg}";

  static String m70(maxImages) =>
      "Press to add photos, up to a maximum of ${maxImages} images";

  static String m71(currency, price) => "from ${currency}${price}";

  static String m72(seconds) => "Resend in ${seconds}s";

  static String m73(businessName) => "Reserve a table at ${businessName}";

  static String m74(city) => "Search in ${city}...";

  static String m75(businessName, appName, menuUrl) =>
      "🍽️ Check out ${businessName}\'s menu on 🌟 ${appName}: \n${menuUrl}";

  static String m76(text) => "Special requests: ${text}";

  static String m77(count) => "${count}d ago";

  static String m78(count) => "${count}h ago";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "managerGuestsMeta": m55,
    "managerHistoryDaySummary": m56,
    ...
    "noNearbyBusinessesInCategory": m63,
    ...
    "pendingReservationsAlertMany": m66,
    ...
    "pressToAddPhotosUpToMaxImages": m70,
