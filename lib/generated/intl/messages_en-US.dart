...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m36(paid, total) => "${paid} of ${total} paid";

  static String m37(amount) => "Pay my share · ${amount}";

  static String m38(size) => "max ${size}";

  static String m39(maxSize) => "Max Size: ${maxSize}";

  static String m40(count) => "${count} new messages";

  static String m41(radius) =>
      "No nearby businesses in this category within ${radius} km.";

  static String m42(text) => "Notes: ${text}";

  static String m43(count) => "Party size: ${count}";

  static String m44(count) => "You have ${count} pending reservations";

  static String m45(max) => "Maximum ${max} photos";

  static String m46(max) => "Photos (optional, up to ${max})";
  ...
  static String m49(currency, price) => "from ${currency}${price}";

  static String m50(seconds) => "Resend in ${seconds}s";

  static String m51(businessName) => "Reserve a table at ${businessName}";
  ...
  static String m54(text) => "Special requests: ${text}";

  static String m55(count) => "${count}d ago";

  static String m56(count) => "${count}h ago";

  static String m57(count) => "${count}m ago";

  static String m58(date) => "Visited on ${date}";

  static String m59(businessName) => "Write a review for ${businessName}";
