...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(max) => "Ao chegar a ${max}, fecha-se a menos usada";

  static String m1(device) =>
      "O ${device} terá de iniciar sessão novamente para usar o Foodly. Os teus outros dispositivos não são afetados.";

  static String m2(used, max) => "${used} de ${max} dispositivos";

  static String m3(date) => "Sessão iniciada a ${date}";

  static String m4(current, total) => "A analisar ${current} de ${total}";
  ...
  static String m6(count) => "${Intl.plural(count, one: 'Detectámos 1 item', other: 'Detectámos ${count} itens')}";

  static String m7(count) => "${Intl.plural(count, one: '1 foto selecionada', other: '${count} fotos selecionadas')}";
  ...
  static String m10(count) => "${Intl.plural(count, one: '1 prato', other: '${count} pratos')}";

  static String m11(items, categories) => "Importámos ${items} itens em ${categories} categorias.";

  static String m12(current, total) => "A carregar ${current} de ${total}";
  ...
  static String m15(name) => "Bloquear ${name}? Deixarás de ver o conteúdo dele e ele o teu.";

  static String m16(businessName) => "Nova atividade em ${businessName}";

  static String m17(actor, businessName) => "${actor} interagiu com ${businessName}";

  static String m18(businessName) => "O menu de ${businessName} está a chamar a atenção!";

  static String m19(businessName) => "Um prato de ${businessName} está em destaque!";

  static String m20(entityName, businessName) => "\"${entityName}\" de ${businessName} está em destaque!";

  static String m21(actor, businessName) => "${actor} gostou de um prato em ${businessName}";

  static String m22(actor, entityName, businessName) => "${actor} gostou de \"${entityName}\" em ${businessName}";

  static String m23(entityName, businessName) => "\"${entityName}\" de ${businessName} está a chamar a atenção!";

  static String m24(actor, businessName) => "${actor} guardou um menu de ${businessName}";

  static String m25(actor, entityName, businessName) => "${actor} guardou o menu \"${entityName}\" de ${businessName}";

  static String m26(businessName) => "Uma promoção de ${businessName} é popular!";

  static String m27(entityName, businessName) => "\"${entityName}\" de ${businessName} é popular!";

  static String m28(actor, businessName) => "${actor} guardou uma promoção de ${businessName}";

  static String m29(actor, entityName, businessName) =>
      "${actor} guardou a promoção \"${entityName}\" de ${businessName}";

  static String m30(businessName) => "${businessName} tem um novo seguidor!";

  static String m31(businessName) => "${businessName} publicou uma nova promoção!";

  static String m32(businessName) => "Nova avaliação em ${businessName}!";

  static String m33(actor, businessName) => "${actor} deixou uma avaliação em ${businessName}";

  static String m34(businessName) => "${businessName} atualizou uma promoção";

  static String m35(currentLabel) => "Renomear secao \"${currentLabel}\"";

  static String m36(year) => "Direitos de Autor © ${year} - Todos os direitos reservados";

  static String m37(businessName) => "Edite sua avaliação para ${businessName}";

  static String m38(phone) => "Insere o código enviado para ${phone}";

  static String m39(errorMsg) => "Falha ao eliminar as fotos do item:\n\n${errorMsg}";

  static String m40(business) => "${business} já está preparando. Continue pedindo — você paga tudo no final.";

  static String m41(amount) => "Pagar a conta · ${amount}";

  static String m42(name, amount) => "Pagar a parte de ${name} (${amount})?";

  static String m43(amount) => "Tempo extra: faltam ${amount}";
  ...
  static String m45(name) => "Pago por ${name}";

  static String m46(paid, total) => "${paid} de ${total} pago";

  static String m47(amount) => "Pagar tudo o que falta (${amount})?";

  static String m48(amount) => "Pagar tudo o que falta · ${amount}";

  static String m49(amount) => "Pagar ${amount}";

  static String m50(amount) => "Pagar a conta · ${amount}";

  static String m51(amount) => "Pagar o pedido · ${amount}";

  static String m52(amount) => "Pagar a minha parte · ${amount}";

  static String m53(total) => "Pagamentos completos · ${total}. O recibo chegou ao seu email.";
  ...
  static String m55(amount) => "Inclui ${amount} de taxa da plataforma de pagamentos";

  static String m56(total) => "Conta fechada · ${total}. O recibo chegou ao seu email.";

  static String m57(base, fee) => "O teu pagamento: ${base} + ${fee} de taxa de processamento";

  static String m58(name) => "Transferir a titularidade para ${name}?";

  static String m59(n) => "RODADA ${n}";

  static String m60(paid, remaining) => "Já foram cobrados ${paid} pela app. Faltam ${remaining} que cobras no local.";

  static String m61(total) =>
      "A mesa consumiu ${total}. A Foodly não processou este pagamento, por isso não cobra comissão.";

  static String m62(guests, items) => "${guests} comensais · ${items} itens";

  static String m63(count, total) => "${count} pedidos · ${total}";

  static String m64(delivered, total) => "${delivered}/${total} itens entregues";

  static String m65(shown, total) => "A mostrar ${shown} de ${total}. Trata destes e os restantes vão subindo.";
  ...
  static String m70(amount) => "Mínimo ${amount} para pagar na app";

  static String m71(count) => "${count} mensagens novas";

  static String m72(radius) => "Não há comércios próximos nesta categoria dentro de ${radius} km.";

  static String m73(text) => "Notas: ${text}";

  static String m74(count) => "Pessoas: ${count}";

  static String m75(amount) => "Pedidos abaixo de ${amount} pagam-se ao balcão.";

  static String m76(count) => "Tem ${count} reservas pendentes";

  static String m77(max) => "Máximo ${max} fotos";

  static String m78(max) => "Fotos (opcional, até ${max})";

  static String m79(action, errorMsg) => "Ocorreu um erro ao ${action} a(s) foto(s) do item: ${errorMsg}";

  static String m80(maxImages) => "Pressione para adicionar fotos, até um máximo de ${maxImages} imagens";

  static String m81(currency, price) => "desde ${currency}${price}";

  static String m82(count, first, last) => "${count} QRs · de ${first} a ${last}";

  static String m83(max) => "Verifica o intervalo — até ${max} mesas.";

  static String m84(seconds) => "Reenviar em ${seconds}s";

  static String m85(businessName) => "Reservar mesa em ${businessName}";

  static String m86(tab) => "Ver ${tab}";

  static String m87(city) => "Procurar em ${city}...";

  static String m88(businessName, appName, menuUrl) =>
      "🍽️ Vê o menu de ${businessName} em 🌟 ${appName}: \n${menuUrl}";

  static String m89(text) => "Pedidos especiais: ${text}";

  static String m90(count) => "há ${count}d";

  static String m91(count) => "há ${count}h";

  static String m92(count) => "há ${count}m";

  static String m93(seconds) => "Demasiadas tentativas seguidas. Tente novamente em ${seconds}s.";

  static String m94(date) => "Visitado em ${date}";

  static String m95(radius) => "Alargar para ${radius} km";

  static String m96(businessName) => "Escreva uma avaliação para ${businessName}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activeSessionsDesktop": MessageLookupByLibrary.simpleMessage("Computador"),
        "activeSessionsDevicesCount": m2,
        "activeSessionsLegacyNotice": MessageLookupByLibrary.simpleMessage(
          "Das sessões abertas antes desta atualização só sabemos a data. Da próxima vez que iniciares sessão nesse dispositivo, aparecerá identificado.",
        ),
        "activeSessionsLoadError": MessageLookupByLibrary.simpleMessage(
          "Não conseguimos carregar as tuas sessões.",
        ),
        "activeSessionsPrivacyNote": MessageLookupByLibrary.simpleMessage(
          "Só guardamos o dispositivo e a última vez que foi usado. Não registamos a tua localização.",
        ),
        "activeSessionsProfileFooter": MessageLookupByLibrary.simpleMessage(
          "Vê onde tens a sessão aberta e fecha aquela que não reconheceres.",
        ),
        ...
        "activeSessionsTitle1": MessageLookupByLibrary.simpleMessage("Sessões "),
        "activeSessionsTitle2": MessageLookupByLibrary.simpleMessage("ativas"),
        ...
        "groupOrderAmountAll": MessageLookupByLibrary.simpleMessage("Toda a conta"),
        "groupOrderAmountMyShare": MessageLookupByLibrary.simpleMessage(
          "A minha parte",
        ),
        ...
        "groupOrderSplitModeHint": MessageLookupByLibrary.simpleMessage(
          "É assim que a conta se divide se cada um pagar o seu. Vais oferecer? No passo seguinte podes pagar tudo.",
        ),
        ...
        "menuCardMinimumNoticeBody": MessageLookupByLibrary.simpleMessage(
          "Abaixo desse valor, o pagamento é ao balcão.",
        ),
        ...
        "noSavedPromotions": MessageLookupByLibrary.simpleMessage(
          "Ainda não tens promoções guardadas",
        ),
        ...
        "paymentModeMinCustom": MessageLookupByLibrary.simpleMessage("Outro"),
        "paymentModeMinOff": MessageLookupByLibrary.simpleMessage("Sem mínimo"),
        "paymentModeMinPrompt": MessageLookupByLibrary.simpleMessage(
          "Escolhe um valor para continuar.",
        ),
        ...
        "qrBatchCount": m82,
        "qrBatchDownload": MessageLookupByLibrary.simpleMessage("Um QR por mesa"),
        "qrBatchFrom": MessageLookupByLibrary.simpleMessage("De"),
        "qrBatchGenerate": MessageLookupByLibrary.simpleMessage("Gerar PDF"),
        "qrBatchHint": MessageLookupByLibrary.simpleMessage(
          "Cada mesa tem o seu QR. Quando um cliente o lê, o pedido já sabe em que mesa está.",
        ),
        ...
        "qrBatchTitle": MessageLookupByLibrary.simpleMessage("Um QR por mesa"),
        "qrBatchTo": MessageLookupByLibrary.simpleMessage("Até"),
        ...
        "servicePackagesEmptyBody": MessageLookupByLibrary.simpleMessage(
          "Um pacote junta o que ofereces e o preço, para que possam reservar sem perguntar.",
        ),
        ...
        "visitPackagesEmptyBody": MessageLookupByLibrary.simpleMessage(
          "Quando publicar algum, vê-lo-ás aqui.",
        ),
        "visitPackagesEmptyTitle": MessageLookupByLibrary.simpleMessage(
          "Este negócio ainda não publicou pacotes",
        ),
        "visitedOn": m94,
