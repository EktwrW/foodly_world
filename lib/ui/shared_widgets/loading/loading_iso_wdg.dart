...
class LoadingWidgetFoodlyIso extends StatefulWidget {
  final double? height;

  const LoadingWidgetFoodlyIso({super.key, this.height});

  @override
  LoadingWidgetFoodlyIsoState createState() => LoadingWidgetFoodlyIsoState();
}

class LoadingWidgetFoodlyIsoState extends State<LoadingWidgetFoodlyIso> with SingleTickerProviderStateMixin {
  late final AnimationController _controller;
  late final List<Animation<double>> _opacityAnimations;
  static const _numberOfImages = 4;
