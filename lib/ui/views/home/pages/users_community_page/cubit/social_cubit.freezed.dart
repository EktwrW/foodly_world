...
class _$SocialStateCopyWithImpl<$Res> implements $SocialStateCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  $SocialVMCopyWith<$Res> get vm {
    return $SocialVMCopyWith<$Res>(_self.vm, (value) {
...
class _Initial implements SocialState {
...
class _Loading implements SocialState {
...
class _Loaded implements SocialState {
...
class _Error implements SocialState {
