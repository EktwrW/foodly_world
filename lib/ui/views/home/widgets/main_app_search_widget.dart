  ...
  Widget build(BuildContext context) {
    return Neumorphic(
      margin: const EdgeInsets.symmetric(
          horizontal: UIDimens.SCREEN_PADDING_MOB, vertical: 12),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon:
              const Icon(Bootstrap.search, color: FoodlyThemes.primaryFoodly),
          suffixIcon: IconButton(
            icon: const Icon(Clarity.map_marker_solid,
