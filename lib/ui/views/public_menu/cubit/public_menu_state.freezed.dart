...
extension PublicMenuStatePatterns on PublicMenuState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Loaded() when loaded != null:
        return loaded(_that.business, _that.menu);
      case _Error() when error != null:
...
class _Initial implements PublicMenuState {
  const _Initial();
...
class _Loading implements PublicMenuState {
  const _Loading();
...
class _Loaded implements PublicMenuState {
  const _Loaded({required this.business, required this.menu});
...
class _Error implements PublicMenuState {
