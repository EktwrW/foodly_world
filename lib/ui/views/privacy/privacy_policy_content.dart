...
const _en = [
  ...
  PolicySection(
    ...
    body: '• Provide and maintain your account and profile.\n'
        ...
        '• Generate AI-assisted promotional text (managers only — your prompts are sent to Google Gemini).\n'
  ...
  PolicySection(
    ...
    body:
        ...
        '• Google (Gemini API): business managers may use AI tools to generate promotional text. Text prompts you enter are sent to Google. Google Privacy Policy: policies.google.com/privacy\n\n'
...
const _es = [
  ...
  PolicySection(
    ...
    body: '• Crear y mantener tu cuenta y perfil.\n'
        ...
        '• Generar texto promocional asistido por IA (solo gestores — tus prompts se envían a Google Gemini).\n'
  ...
  PolicySection(
    ...
    body:
        ...
        '• Google (API de Gemini): los gestores de negocios pueden usar herramientas de IA para generar texto promocional. Los prompts de texto que introduces se envían a Google. Política de privacidad de Google: policies.google.com/privacy\n\n'
...
const _pt = [
  ...
  PolicySection(
    ...
    body: '• Criar e manter a sua conta e perfil.\n'
        ...
        '• Gerar texto promocional assistido por IA (apenas gestores — os seus prompts são enviados para a Google Gemini).\n'
  ...
  PolicySection(
    ...
    body:
        ...
        '• Google (API Gemini): os gestores de negócios podem usar ferramentas de IA para gerar texto promocional. Os prompts de texto que introduz são enviados para a Google. Política de privacidade da Google: policies.google.com/privacy\n\n'
