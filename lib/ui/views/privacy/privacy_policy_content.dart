...
const _en = [
  ...
  PolicySection(
    ...
    body: 'DATA YOU PROVIDE DIRECTLY\n\n'
        ...
        '• Precise location (GPS): with your explicit permission, to find nearby businesses and personalise results. Coordinates are transmitted during location-based requests and may be stored if you save an address. Background location keeps location-based features active when you switch apps; you can revoke this permission at any time in your device settings.\n'
