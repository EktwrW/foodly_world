...
mixin _$VisitServicePackagesState {
  ...
  @override
  String toString() {
    return 'VisitServicePackagesState()';
  }
}
...
extension VisitServicePackagesStatePatterns on VisitServicePackagesState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Loaded() when loaded != null:
        return loaded(_that.profile, _that.packages, _that.allowReservations);
      case _Error() when error != null:
...
class _Initial implements VisitServicePackagesState {
  const _Initial();
...
class _Loading implements VisitServicePackagesState {
  const _Loading();
...
class _Error implements VisitServicePackagesState {
