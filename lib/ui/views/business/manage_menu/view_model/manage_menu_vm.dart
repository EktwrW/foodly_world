...
import 'package:foodly_world/core/services/dependency_injection_service.dart' show AuthSessionService, MenuCategory, di;
import 'package:foodly_world/data_models/menu/menu_dm.dart';
import 'package:freezed_annotation/freezed_annotation.dart';

export 'package:foodly_world/data_models/menu/item_dm.dart';

part 'manage_menu_vm.freezed.dart';

@freezed
abstract class ManageMenuVM with _$ManageMenuVM {
  const ManageMenuVM._();

  const factory ManageMenuVM({
    MenuDM? menuDM,
    MenuDM? editMenuDM,
