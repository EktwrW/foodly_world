...
class _ManagePromotionsHeader extends StatelessWidget {
  const _ManagePromotionsHeader({
    super.key,
    required this.vm,
  });
  ...
  void _addNewPromotion(BuildContext context, ManagePromotionsCubit cubit) {
    context.read<ManagePromotionsCubit>()
      ..setControllers()
