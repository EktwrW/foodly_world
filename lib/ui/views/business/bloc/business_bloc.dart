...
class BusinessBloc extends Bloc<BusinessEvent, BusinessState> {
  ...
  BusinessBloc(
    ...
    add(const BusinessEvent.started());
  }
  ...
  Map<DashboardEditing, bool> get _cantEditBusiness => {
        DashboardEditing.name: notValidName || _vm.currentBusiness?.uuid == null,
        DashboardEditing.address: notValidLocation || _vm.currentBusiness?.uuid == null,
        DashboardEditing.category: notValidCategory || _vm.currentBusiness?.uuid == null,
        DashboardEditing.aboutUs: notValidAboutUs || _vm.currentBusiness?.uuid == null,
        DashboardEditing.openingHours: notValidOpeningHours || _vm.currentBusiness?.uuid == null,
        DashboardEditing.services: notValidServices || _vm.currentBusiness?.uuid == null,
        DashboardEditing.contactUs: notValidContactUs || _vm.currentBusiness?.uuid == null,
        DashboardEditing.additionalInfo: notValidAdditionalInfo || _vm.currentBusiness?.uuid == null,
      };
  ...
  void _setOpeningHours(_SetOpeningHoursDay value, Emitter<BusinessState> emit) {
  ...
  Future<void> _callToUpdateBusiness(Emitter emit) async {
    ...
    if (_cantEditBusiness[_vm.dashboardEditing] ?? true) {
      return;
    }
  ...
  void _updateBusinessInCurrentArray(BusinessDM updatedBusiness) {
    ...
    final businesses = List.generate(
        length, (i) => _vm.myBusinessesses[i].uuid == updatedBusiness.uuid ? updatedBusiness : _vm.myBusinessesses[i]);
