              ...
              Row(
                children: [
                  _buildDropdownButton(
                    ...
                    value: day?.openA,
                    onChanged: (hour) => bloc
                        .add(DashboardEvent.setOpeningHoursDay(i, day?.copyWith(openA: hour?.value) ?? const Day())),
                  ...
                  _buildDropdownButton(
                    ...
                    value: day?.closeA,
                    onChanged: (hour) => bloc
                        .add(DashboardEvent.setOpeningHoursDay(i, day?.copyWith(closeA: hour?.value) ?? const Day())),
                    ...
                    children: [
                      _buildDropdownButton(
                        ...
                        onChanged: (hour) => bloc.add(
                            DashboardEvent.setOpeningHoursDay(i, day?.copyWith(openB: hour?.value) ?? const Day())),
                        validator: (p0) =>
                      ...
                      _buildDropdownButton(
                        ...
                        value: day?.closeB,
                        onChanged: (hour) => bloc.add(
                            DashboardEvent.setOpeningHoursDay(i, day?.copyWith(closeB: hour?.value) ?? const Day())),
                        validator: (p0) =>
          ...
          FadeIn(
            child: IconButton.filled(
              onPressed: _enableAddPeriodBtn
                  ? () => bloc
                      .add(DashboardEvent.setOpeningHoursDay(i, day?.copyWith(showSecondPeriod: true) ?? const Day()))
                  : null,
