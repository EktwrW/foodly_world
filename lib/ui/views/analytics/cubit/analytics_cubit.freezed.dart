...
mixin _$AnalyticsState {
  AnalyticsVM get vm => throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$AnalyticsStateCopyWithImpl<$Res, $Val extends AnalyticsState>
  ...
  @pragma('vm:prefer-inline')
  $AnalyticsVMCopyWith<$Res> get vm {
    return $AnalyticsVMCopyWith<$Res>(_value.vm, (value) {
...
abstract class _Initial implements AnalyticsState {
  const factory _Initial(final AnalyticsVM vm) = _$InitialImpl;
...
abstract class _Loading implements AnalyticsState {
  const factory _Loading(final AnalyticsVM vm) = _$LoadingImpl;
...
abstract class _Loaded implements AnalyticsState {
  const factory _Loaded(final AnalyticsVM vm) = _$LoadedImpl;
...
abstract class _Error implements AnalyticsState {
  const factory _Error(final AnalyticsVM vm, final String message) =
      _$ErrorImpl;
