...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AppRequestException error) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(AppRequestException error)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$ErrorImpl<T> implements _Error<T> {
  ...
  @override
  final AppRequestException error;
...
abstract class _Error<T> implements ApiResult<T> {
  const factory _Error(final AppRequestException error) = _$ErrorImpl<T>;

  AppRequestException get error;
