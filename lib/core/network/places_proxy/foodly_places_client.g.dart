...
part of 'foodly_places_client.dart';
...
class _FoodlyPlacesClient implements FoodlyPlacesClient {
  _FoodlyPlacesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GeocodingResponseDM> reverse(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GeocodingResponseDM _value;
    try {
      _value = GeocodingResponseDM.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<GeocodingResponseDM> forward(GeocodingForwardRequestDTO body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<GeocodingResponseDM>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/geocoding/forward',
