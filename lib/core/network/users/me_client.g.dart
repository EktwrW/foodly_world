...
class _MeClient implements MeClient {
  ...
  @override
  Future<ActiveSessionsDM> getActiveSessions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ActiveSessionsDM>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/sessions',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ActiveSessionsDM _value;
    try {
      _value = ActiveSessionsDM.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
